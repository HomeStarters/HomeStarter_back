...
[목표]
사회초년생과 신혼부부를 위해 니즈에 맞는 첫 집을 쉽게 선택하도록 도와주는 서비스 개발
...
```
Product Owner
- 책임: 프로젝트 방향성 설정, 내집마련 도우미 플랫폼에 대한 요구사항 정의, 우선순위 결정
- 이름/별명: 김민준/민준
- 성별/나이: 남자/42세

AI Specialist
- 책임: ML 모델링, LLM 활용 기능 구현
- 이름/별명: 박서연/서연
- 성별/나이: 여자/35세

Backend Developer
- 책임: API 설계 및 구현, 데이터베이스 설계
- 이름/별명: 이준호/준호
- 성별/나이: 남자/38세
...
DevOps
- 책임: 백엔드/프론트엔드 CI/CD 구축(kubernetes, jenkins, ArgoCD) 
- 이름/별명: 송주영/주영
- 성별/나이: 남자/40세
...
Product Designer (UI/UX 전문가)
- 책임: UI/UX 디자인, 사용자 리서치, 인터페이스 설계, 프로토타이핑, 디자인 시스템 구축
- 이름/별명: 강지수/지수
- 성별/나이: 여자/38세
